      ...
      <div className='flex flex-col w-full md:w-1/2'>
        ...
        <div className='flex flex-col justify-center px-8 pt-8 my-auto md:justify-start md:pt-0 md:px-24 lg:px-32'>
          ...
          <form className='flex flex-col pt-3 md:pt-8'>
            ...
            <button
              type='submit'
              className='w-full px-4 py-2 text-base font-semibold text-center text-white transition duration-200 ease-in bg-quinary shadow-md hover:text-black hover:bg-tertiary focus:outline-none focus:ring-2'
            >
              <span className='w-full text-textColor'>Submit</span>
            </button>
          </form>
          <div className='pt-12 pb-12 text-center'>
            <p>
              Don&#x27;t have an account?
              <a href='/' className='font-semibold underline ml-3 hover:text-textColor'>
                Register here.
              </a>
            </p>
          </div>
