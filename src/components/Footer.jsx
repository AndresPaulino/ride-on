      ...
      <div className='px-4 py-16 sm:px-6 lg:px-8 lg:col-span-3'>
        ...
        <div className='pt-12 mt-12 border-t border-gray-800'>
          ...
          <p className='mt-8 text-xs text-gray-500'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus mollitia quia quod repellendus. Porro
            harum, odio dolore perspiciatis praesentium provident esse consequatur quibusdam aperiam, cupiditate omnis
            modi in quasi? In, maxime odio vel repellat sed earum? Debitis quaerat facilis animi. Odio natus nostrum
