      ...
      <div className='px-4 py-16 sm:px-6 lg:px-8 lg:col-span-3'>
        <div className='grid grid-cols-1 gap-8 sm:grid-cols-2'>
          <div>
            <p className='font-medium'>
              ...
              <a className='block text-2xl sm:text-3xl hover:opacity-75' href='/home'>
                786-261-7832
              </a>
            </p>
            ...
            <div className='flex mt-16 space-x-3'>
              <a
                ...
                href='https://twitter.com/iandresmiguel'
                target='_blank'
                rel='noreferrer'
              >
              ...
              <a
                className='p-2 border rounded-full border-white/25 hover:opacity-75'
                href='https://www.linkedin.com/in/andrespaulino/'
                target='_blank'
                rel='noreferrer'
              >
          ...
          <div className='grid grid-cols-1 gap-4 sm:grid-cols-2'>
            <div>
              ...
              <nav className='flex flex-col mt-4 space-y-2 text-sm text-gray-300'>
                <a className='hover:opacity-75' href='/home'>
                  {' '}
                  Contact{' '}
                </a>
                <a className='hover:opacity-75' href='/home'>
        ...
        <div className='pt-12 mt-12 border-t border-gray-800'>
          <div className='text-sm text-gray-300 sm:items-center sm:justify-between sm:flex'>
            ...
            <p className='mt-4 sm:mt-0'>&copy; 2022 RideOn</p>
          </div>
